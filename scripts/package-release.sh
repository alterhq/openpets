...
test -f "$APP_BUNDLE/Contents/Resources/OpenPetsKit_OpenPetsKit.bundle/pet.json"
test -f "$APP_BUNDLE/Contents/Resources/OpenPetsKit_OpenPetsKit.bundle/spritesheet.webp"
